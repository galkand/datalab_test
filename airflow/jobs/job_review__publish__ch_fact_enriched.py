...
SRC_TABLE = "yelp_mart.mart_review_fact_enriched"
DST_TABLE = "mart_review_fact_enriched"
...
def main() -> None:
    ...
    app_name = args.app_name or "job_review__publish__ch_fact_enriched"
    ...
    df = df.withColumn("review_date", F.date_format("review_date", "yyyy-MM-dd HH:mm:ss"))
